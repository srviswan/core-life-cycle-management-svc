 ...
 */
@Entity
@Table(name = "cash_flows", schema = "cashflow")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
...
public class CashFlow {
    ...
    @Index(name = "idx_cash_flows_contract_id")
    @Index(name = "idx_cash_flows_cash_flow_date")
    @Index(name = "idx_cash_flows_status")
    @Index(name = "idx_cash_flows_request_id")
    @Index(name = "idx_cash_flows_calculation_id")
    @Index(name = "idx_cash_flows_contract_date_type")
    @Index(name = "idx_cash_flows_lot_id")
}
