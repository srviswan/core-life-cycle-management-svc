...
public class DividendCalculator {
     ...
     */
    private double applyWithholdingTax(MarketData.DividendData.Dividend dividend, double grossAmount) {
    ...
    private WithholdingTaxInfo createWithholdingTaxInfo(CashFlowRequest.Contract contract,
                                                        MarketData.DividendData.Dividend dividend,
    ...
    /**
     * Map MarketData.DividendData.Dividend.WithholdingTreatment to WithholdingTaxInfo.WithholdingTreatment
     */
    private WithholdingTaxInfo.WithholdingTreatment mapWithholdingTreatment(MarketData.DividendData.Dividend.WithholdingTreatment treatment) {
        if (treatment == null) {
            return null;
        }
