...
public interface CalculationRequestRepository extends JpaRepository<com.financial.cashflow.repository.CalculationRequestEntity, String> {
     ...
     */
    CalculationRequestEntity findByRequestId(String requestId);
    
    /**
     * Find calculation requests by contract with filters
     */
    @Query("SELECT cr FROM CalculationRequestEntity cr WHERE cr.contractId = :contractId " +
    ...
    List<CalculationRequestEntity> findByContractWithFilters(
