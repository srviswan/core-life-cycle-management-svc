 ...
 */
@Repository
public interface CalculationRequestRepository extends JpaRepository<CalculationRequestEntity, String> {
     ...
     */
    @Query("SELECT new com.financial.cashflow.dto.CalculationRequestsResponse$CalculationRequestInfo(" +
