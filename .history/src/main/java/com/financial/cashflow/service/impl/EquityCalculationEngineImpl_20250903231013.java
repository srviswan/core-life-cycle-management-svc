...
public class EquityCalculationEngineImpl implements EquityCalculationEngine {
    ...
    public List<CashFlowResponse.CashFlow> calculateCorporateActionFlows(
        ...
        // TODO: Implement corporate action processing when the field is added to CashFlowRequestContent
        // For now, return empty list as corporate actions are not yet supported in the request model
    ...
    public CashFlowRequestContent.Position applyCorporateAction(
            CashFlowRequestContent.Position position,
            EquityCalculationEngine.CorporateAction corporateAction) {
    ...
    private double calculateAdjustedQuantity(double originalQuantity, EquityCalculationEngine.CorporateAction corporateAction) {
    ...
    private double calculateAdjustedPrice(double originalPrice, EquityCalculationEngine.CorporateAction corporateAction) {
        switch (corporateAction.getActionType()) {
            case "SPLIT":
