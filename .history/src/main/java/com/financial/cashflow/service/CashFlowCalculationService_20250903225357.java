...
public class CashFlowCalculationService {
     ...
     * @return List of CompletableFuture containing the calculation responses
     */
    public List<CompletableFuture<CashFlowResponse>> calculateCashFlowsBatch(List<CashFlowRequestContent> requests) {
