...
public class SettlementServiceImpl implements SettlementService {
    ...
    private CashFlowResponse.SettlementInstruction createSettlementInstruction(
            CashFlowResponse.CashFlow cashFlow, CashFlowRequestContent request) {
        ...
        return CashFlowResponse.SettlementInstruction.builder()
            ...
            .status("PENDING")
            .priority(getPriorityValue(determinePriority(cashFlow)))
            .settlementMethod(determineSettlementMethod(cashFlow))
            .referenceNumber(generateReferenceNumber(cashFlow))
