...
class CashFlowIntegrationTest {
    ...
    void shouldVerifyControllerIsRegistered() {
        ...
        // Try to access the health endpoint which should always be available
        ResponseEntity<String> response = restTemplate.getForEntity(
            "http://localhost:" + port + "/api/v1/cashflows/health",
            String.class
        );
        
        // Even if it fails, we should get a response (not 404)
