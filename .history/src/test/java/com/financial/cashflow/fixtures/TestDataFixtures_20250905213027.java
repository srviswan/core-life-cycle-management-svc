...
public class TestDataFixtures {
    ...
    public CashFlowRequest createIbmEquitySwapRequest() {
        return CashFlowRequest.builder()
                ...
                .dateRange(CashFlowRequest.DateRange.builder()
                        ...
                        .calculationFrequency(CashFlowRequest.CalculationFrequency.DAILY)
                        .build())
    ...
    public CashFlowRequest createLargeNotionalEquitySwapRequest() {
        ...
        request.getContracts().get(0).setNotionalAmount(BigDecimal.valueOf(10000000.0)); // $10M
        return request;
    }
    ...
    public CashFlowRequest createMultiUnderlyingRequest() {
        ...
        request.getContracts().add(
                CashFlowRequest.Contract.builder()
                        ...
                        .underlying("MSFT")
                        .index("LIBOR_3M")
                        .notionalAmount(BigDecimal.valueOf(750000.0))
                        .currency("USD")
                        .type(CashFlowRequest.ContractType.EQUITY_SWAP)
                        .startDate(LocalDate.of(2024, 1, 1))
                        .endDate(LocalDate.of(2024, 1, 31))
    ...
    public CashFlowRequest createEurBasedRequest() {
        ...
        request.getContracts().get(0).setIndex("EURIBOR_3M");
        request.getMarketData().getData().getRates().get(0).setIndex("EURIBOR_3M");
    ...
    public CashFlowRequest createEndpointsMarketDataRequest() {
        ...
        request.getMarketDataStrategy().setMode(CashFlowRequest.MarketDataStrategy.Mode.ENDPOINTS);
    ...
    public CashFlowRequest createZeroNotionalRequest() {
        ...
        request.getContracts().get(0).setNotionalAmount(BigDecimal.ZERO);
        return request;
    }
