...
class DividendCalculationResultTest {
    ...
    void testGetTotalGrossDividendAmount_EmptyDetails() {
        ...
        // Then
        assertEquals(0.0, totalGrossDividend); // Returns 0.0 when details are empty (sum of empty list)
    }
    ...
    void testNoArgsConstructor() {
        ...
        // Then
        assertNotNull(dividendCalculationResult);
        assertEquals(0.0, dividendCalculationResult.getTotalDividendAmount()); // Lombok initializes with 0.0
