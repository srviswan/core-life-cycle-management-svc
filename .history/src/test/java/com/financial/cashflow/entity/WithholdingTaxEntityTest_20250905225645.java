...
class WithholdingTaxEntityTest {
    ...
    void testEntityAuditFields() {
        ...
        // Then
        assertNotNull(updatedEntity.getCreatedAt()); // created_at should exist
        assertNotNull(updatedEntity.getUpdatedAt()); // updated_at should exist
        assertEquals(300.0, updatedEntity.getWithholdingTaxAmount()); // Verify update worked
    }
