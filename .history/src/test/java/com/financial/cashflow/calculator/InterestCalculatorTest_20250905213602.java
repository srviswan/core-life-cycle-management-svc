...
class InterestCalculatorTest {
    ...
    void testCalculateInterestWithMissingRateData() {
        ...
        assertTrue(exception.getMessage().contains("Interest calculation failed"),
                "Expected exception message to contain 'Interest calculation failed', but was: " + exception.getMessage());
        
        // Check that the cause contains the original error
        assertNotNull(exception.getCause());
        assertTrue(exception.getCause().getMessage().contains("Rate data not found for index: LIBOR_3M"),
                "Expected cause message to contain 'Rate data not found for index: LIBOR_3M', but was: " + exception.getCause().getMessage());
    }
    ...
    void testCalculateInterestWithIndexMismatch() {
        ...
        assertTrue(exception.getMessage().contains("Rate data not found for index: LIBOR_3M"),
                "Expected exception message to contain 'Rate data not found for index: LIBOR_3M', but was: " + exception.getMessage());
    }
