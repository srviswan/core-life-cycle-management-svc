...
class InterestCalculatorTest {
    ...
    void setUp() {
        ...
        interestRateSwapContract = CashFlowRequest.Contract.builder()
                ...
                .underlying("USD")
                .index("LIBOR_3M")
                .notionalAmount(BigDecimal.valueOf(5000000.0))
                .currency("USD")
    ...
    void testCalculateInterestForUnsupportedType() {
        // Arrange
        CashFlowRequest.Contract unsupportedContract = equitySwapContract.toBuilder()
                .type(CashFlowRequest.ContractType.FORWARD)
                .build();
    ...
    void testCalculateInterestWithNullNotional() {
        // Arrange
        CashFlowRequest.Contract contractWithNullNotional = equitySwapContract.toBuilder()
                .notionalAmount(null)
                .build();
    ...
    void testCalculateInterestWithMissingRateData() {
        // Arrange
        MarketData marketDataWithoutRate = marketData.toBuilder()
                .rate(null)
                .build();
    ...
    void testCalculateInterestWithIndexMismatch() {
        // Arrange
        MarketData marketDataWithDifferentIndex = marketData.toBuilder()
                .rate(MarketData.RateData.builder()
                        .index("SOFR")
                        .baseRate(0.0450)
                        .baseDate(LocalDate.now())
    ...
    void testCalculateInterestForDifferentDateRanges() {
        // Test 1-day period
        CashFlowRequest.Contract oneDayContract = equitySwapContract.toBuilder()
                .startDate(LocalDate.of(2024, 1, 1))
        ...
        CashFlowRequest.Contract oneYearContract = equitySwapContract.toBuilder()
                .startDate(LocalDate.of(2024, 1, 1))
    ...
    void testCalculateInterestForLeapYear() {
        ...
        CashFlowRequest.Contract leapYearContract = equitySwapContract.toBuilder()
                .startDate(LocalDate.of(2024, 1, 1))
