...
class DividendCalculatorTest {
    ...
    void testCalculateDividendsForDifferentNotionalAmounts() {
        ...
        // Calculate expected dividends with withholding tax (GROSS_UP treatment)
        double grossDividend1 = 10000000.0 * 1.65 / 1000000.0; // 16.5
        double grossDividend2 = 10000000.0 * 1.65 / 1000000.0; // 16.5
        double netDividend1 = grossDividend1 - (grossDividend1 * 0.15); // 16.5 - 2.475 = 14.025
        double netDividend2 = grossDividend2 - (grossDividend2 * 0.15); // 16.5 - 2.475 = 14.025
        double expectedLargeDividends = netDividend1 + netDividend2; // 28.05
