...
class DividendCalculatorTest {
    ...
    void testCalculateEquitySwapDividends() {
        ...
        // Calculate expected dividends with withholding tax (GROSS_UP treatment)
        double grossDividend1 = 1000000.0 * 1.65 / 1000000.0; // 1.65
        double grossDividend2 = 1000000.0 * 1.65 / 1000000.0; // 1.65
        double netDividend1 = grossDividend1 - (grossDividend1 * 0.15); // 1.65 - 0.2475 = 1.4025
        double netDividend2 = grossDividend2 - (grossDividend2 * 0.15); // 1.65 - 0.2475 = 1.4025
        double expectedDividends = netDividend1 + netDividend2; // 2.805
    ...
    void testCalculateDividendsForDifferentNotionalAmounts() {
        ...
        // Calculate expected dividends with withholding tax (GROSS_UP treatment)
        double grossDividend1 = 100000.0 * 1.65 / 1000000.0; // 0.165
        double grossDividend2 = 100000.0 * 1.65 / 1000000.0; // 0.165
        double netDividend1 = grossDividend1 - (grossDividend1 * 0.15); // 0.165 - 0.02475 = 0.14025
        double netDividend2 = grossDividend2 - (grossDividend2 * 0.15); // 0.165 - 0.02475 = 0.14025
        double expectedSmallDividends = netDividend1 + netDividend2; // 0.2805
        ...
        // Calculate expected dividends with withholding tax (GROSS_UP treatment)
        double largeGrossDividend1 = 10000000.0 * 1.65 / 1000000.0; // 16.5
        double largeGrossDividend2 = 10000000.0 * 1.65 / 1000000.0; // 16.5
        double largeNetDividend1 = largeGrossDividend1 - (largeGrossDividend1 * 0.15); // 16.5 - 2.475 = 14.025
        double largeNetDividend2 = largeGrossDividend2 - (largeGrossDividend2 * 0.15); // 16.5 - 2.475 = 14.025
        double expectedLargeDividends = largeNetDividend1 + largeNetDividend2; // 28.05
    ...
    void testCalculateDividendsWithDifferentAmounts() {
        ...
        // Calculate expected dividends with withholding tax (GROSS_UP treatment)
        double grossDividend1 = 1000000.0 * 2.50 / 1000000.0; // 2.50
        double grossDividend2 = 1000000.0 * 0.80 / 1000000.0; // 0.80
        double netDividend1 = grossDividend1 - (grossDividend1 * 0.15); // 2.50 - 0.375 = 2.125
        double netDividend2 = grossDividend2 - (grossDividend2 * 0.15); // 0.80 - 0.12 = 0.68
        double expectedDividends = netDividend1 + netDividend2; // 2.805
        assertEquals(expectedDividends, dividends, 0.01);
    }
    ...
    void testCalculateDividendsWithFutureDates() {
        ...
        // Calculate expected dividends with withholding tax (GROSS_UP treatment)
        double grossDividend = 1000000.0 * 1.65 / 1000000.0; // 1.65
        double expectedDividends = grossDividend - (grossDividend * 0.15); // 1.65 - 0.2475 = 1.4025
        assertEquals(expectedDividends, dividends, 0.01);
    }
}
