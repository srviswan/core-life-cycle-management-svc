...
class CashFlowControllerIntegrationTest {
    ...
    void testCalculateRealTimeCashFlowsDifferentMarketDataStrategies() throws Exception {
        ...
        selfContainedRequest.getMarketDataStrategy().setMode(CashFlowRequest.MarketDataStrategy.Mode.SELF_CONTAINED);
        ...
        endpointsRequest.getMarketDataStrategy().setMode(CashFlowRequest.MarketDataStrategy.Mode.ENDPOINTS);
